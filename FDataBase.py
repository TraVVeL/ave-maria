...
class FDataBase:
    ...
    def user_order(self, user_id, product_id, product_count, name, phone, mail, secondary_name, secondary_phone, city,
                   street, building_address, entrance, floor, apartment, deliver, deliver_time, note, delivered):
        tm = math.floor(time.time())
        try:
            self.__cur.execute("INSERT INTO user_order VALUES "
                               ...
                               "?, ?, ?, ?, ?, "
                               "?, ?, ?, ?, ?)",
                               (user_id, product_id, product_count, name, phone, mail,
                                secondary_name, secondary_phone, city, street, building_address,
